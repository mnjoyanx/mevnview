<template>
	<div class="overflow-x-auto bg-gray-100 pt-8">
		<div
			class="min-w-screen container mx-auto min-h-screen font-sans overflow-hidden"
		>
			<p class="text-4xl text-blue-500">Cart</p>
